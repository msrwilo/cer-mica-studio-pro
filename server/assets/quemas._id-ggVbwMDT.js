import { $ as commonjsGlobal, P as getDefaultExportFromCjs, r as reactExports, T as React, U as jsxRuntimeExports } from "./worker-entry-CDL59hpK.js";
import { R as Route, a as useQueryClient, L as Link, s as supabase, t as toast } from "./router-CXOYXOoj.js";
...
import { L as Label$1 } from "./label-ao884MsU.js";
import { c as createLucideIcon, b as clsx } from "./createLucideIcon-wO4OZstR.js";
import "node:events";
...
function QuemaDetallePage() {
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("quemas").select("*").eq("id_quema", id).single();
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data,
        error
      } = await supabase.from("firing_logs").select("*").eq("id_quema", id).order("tiempo");
      if (error) throw error;
      return data ?? [];
    }
  });
  ...
  const addLog = async (e) => {
    ...
    const {
      error
    } = await supabase.from("firing_logs").insert({
      id_quema: id,
  ...
  const exportCsv = () => {
    ...
    const rows = logs.map((l) => header.map((k2) => JSON.stringify(l[k2] ?? "")).join(","));
    ...
    a2.href = url;
    a2.download = `bitacora-${id}.csv`;
    a2.click();
    URL.revokeObjectURL(url);
  };
  const chartData = (logs ?? []).map((l, i, arr) => ({
    t: new Date(l.tiempo).getTime(),
    label: new Date(l.tiempo).toLocaleTimeString("es-MX", {
      hour: "2-digit",
      minute: "2-digit"
    }),
    temperatura: Number(l.temperatura_c),
    horas: arr[0] ? (new Date(l.tiempo).getTime() - new Date(arr[0].tiempo).getTime()) / 36e5 : 0
  }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/quemas", className: "inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex flex-wrap items-end justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-semibold tracking-tight", children: quema?.id_quema ?? id }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: exportCsv, disabled: !logs?.length, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [{
      label: "Inicio",
      value: fmtDateTime(quema?.inicio_de_quema)
    }, {
      label: "Fin",
      value: fmtDateTime(quema?.fin_de_quema)
    }, {
      label: "Temp. estimada",
      value: `${fmtNum(quema?.temperatura_estimada, 0)} °C`
    }, {
      label: "Temp. alcanzada",
      value: `${fmtNum(quema?.temperatura_alcanzada, 0)} °C`
    }].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wide text-muted-foreground", children: k2.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-lg font-medium tabular-nums", children: k2.value })
    ] }) }, k2.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Temperatura vs. tiempo" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { style: {
        height: 320
      }, children: chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Aún no hay lecturas." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: chartData, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.32 0.025 45)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "label", stroke: "oklch(0.72 0.04 70)", fontSize: 12 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.72 0.04 70)", fontSize: 12, unit: " °C" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
          background: "oklch(0.22 0.025 50)",
          border: "1px solid oklch(0.32 0.025 45)",
          borderRadius: 8
        } }),
        quema?.temperatura_estimada > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(ReferenceLine, { y: Number(quema.temperatura_estimada), stroke: "oklch(0.78 0.10 90)", strokeDasharray: "4 4", label: {
          value: "Objetivo",
          fill: "oklch(0.78 0.10 90)",
          fontSize: 11
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "temperatura", stroke: "oklch(0.62 0.17 40)", strokeWidth: 2, dot: {
          r: 3
        } })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Agregar lectura" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: addLog, className: "grid gap-3 sm:grid-cols-[1fr_2fr_auto] sm:items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "temp", children: "Temperatura (°C)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "temp", type: "number", step: "1", value: temp, onChange: (e) => setTemp(e.target.value), required: true })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "obs", children: "Observaciones" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "obs", value: obs, onChange: (e) => setObs(e.target.value), placeholder: "Apertura de chimenea, color de llama..." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", disabled: saving, children: saving ? "Guardando..." : "Agregar" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-left text-xs uppercase text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3", children: "Tiempo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-right", children: "Temp." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3", children: "Observaciones" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: (logs ?? []).map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 font-mono text-xs", children: l.id_bq }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2", children: fmtDateTime(l.tiempo) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-2 text-right tabular-nums", children: [
            fmtNum(l.temperatura_c, 0),
            " °C"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground", children: l.observaciones ?? "—" })
        ] }, l.id_bq)) })
      ] }) })
    ] })
  ] });
