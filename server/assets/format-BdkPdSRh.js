import { S as Subscribable, p as pendingThenable, r as resolveQueryBoolean, b as shallowEqualObjects, c as resolveStaleTime, n as noop, e as environmentManager, i as isValidTimeout, d as timeUntilStale, f as timeoutManager, g as focusManager, h as fetchState, j as replaceData, k as notifyManager, l as shouldThrowError, a as useQueryClient } from "./router-CXOYXOoj.js";
import { r as reactExports } from "./worker-entry-CDL59hpK.js";
...
const fmtMoney = (n) => new Intl.NumberFormat("es-MX", { style: "currency", currency: "MXN", maximumFractionDigits: 2 }).format(Number(n ?? 0));
const fmtNum = (n, d = 2) => new Intl.NumberFormat("es-MX", { maximumFractionDigits: d }).format(Number(n ?? 0));
const fmtDateTime = (d) => {
  if (!d) return "—";
